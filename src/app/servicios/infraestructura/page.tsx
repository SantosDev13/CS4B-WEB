...
const servicio = {
  ...
  descripcion: "Diseñamos e implementamos la infraestructura tecnológica que tu empresa necesita para crecer. Cloud, redes, servidores y más, todo optimizado para tu negocio.",
  color: "#8b5cf6",
};
      ...
      <section id="contacto" className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Contáctanos para optimizar tu infraestructura</p>
          </div>
