...
const servicio = {
  ...
  descripcion: "Equipo de soporte disponible 24/7 para resolver cualquier incidencia. Mantenimiento preventivo, actualizaciones y atención inmediata cuando más lo necesitas.",
  color: "#f59e0b",
};
      ...
      <section id="contacto" className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Contáctanos y nuestro equipo te atenderá</p>
          </div>
