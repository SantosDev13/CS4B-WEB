...
const servicio = {
  ...
  descripcion: "Protegemos tus activos más valiosos con soluciones de ciberseguridad de nivel empresarial. Auditorías, pentesting, gestión de vulnerabilidades y más.",
  color: "#ef4444",
};
      ...
      <section id="contacto" className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Contáctanos para proteger tu empresa</p>
          </div>
